...
aggregate_accel_data %>%
    knitr::kable(caption = "Total Activity (mean minutes) Count for Each Day of the Dataset") %>%
  kable_styling(bootstrap_options = c("striped", "condensed", font_size = 12))
```
...
Total Activity (mean minutes) Count for Each Day of the
Dataset
...
accel_data %>%
  ...
  geom_line() +
  labs(
    title = "Physicial Activity of a 63-year-old Male Across Five Weeks by Day of the Week",
    x = "Day of the Week",
    y = "Activity Counts",
...
accel_data %>%
  ...
  geom_line() +
  labs(
    title = "Physicial Activity of a 63-year-old Male Across the Days of the Week over Five Weeks",
    x = "Week",
    y = "Activity Counts",
    caption = "Data from the Accelerometer Dataset")
```
...
accel_data %>%
  ...
  geom_line() +
  labs(
    title = "Physicial Activity of a 63-year-old Male in a 24-Hour Day Across 5 Weeks",
...
<img src="p8105_hw3_10142019_files/figure-gfm/unnamed-chunk-20-1.png" width="90%" />
...
<img src="p8105_hw3_10142019_files/figure-gfm/unnamed-chunk-21-1.png" width="90%" />
...
<img src="p8105_hw3_10142019_files/figure-gfm/unnamed-chunk-22-1.png" width="90%" />
